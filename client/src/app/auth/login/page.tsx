        ...
        <div className="min-h-screen flex bg-[#050510] overflow-x-hidden overflow-y-auto">
            ...
            <div className="hidden lg:flex lg:w-[45%] relative items-center justify-center">
                ...
                <div className="absolute inset-0 overflow-hidden">
                    <div className="absolute top-[10%] left-[10%] w-[500px] h-[500px] rounded-full bg-indigo-600/15 blur-[120px] animate-pulse" />
                    ...
                    <div className="absolute top-[40%] left-[30%] w-[300px] h-[300px] rounded-full bg-purple-600/8 blur-[80px] animate-pulse [animation-delay:4s]" />
                </div>
                ...
                <div className="relative z-10 max-w-md px-12 space-y-8">
                    ...
                    <h1 className="text-5xl font-black text-white leading-tight tracking-tight">
                        Welcome back,<br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-blue-400">Champion.</span>
                    </h1>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    className="h-14 rounded-[1rem] bg-white/[0.03] border-white/5 text-white placeholder:text-slate-700 focus:bg-white/[0.06] focus:border-indigo-500/50 focus:ring-4 focus:ring-indigo-500/10 transition-all px-5"
                                    value={email}
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        placeholder="••••••••"
                                        className="h-14 rounded-[1rem] bg-white/[0.03] border-white/5 text-white placeholder:text-slate-700 focus:bg-white/[0.06] focus:border-indigo-500/50 focus:ring-4 focus:ring-indigo-500/10 transition-all px-5 pr-14"
                                        value={password}
                            ...
                            <Button 
                                type="submit" 
                                disabled={isLoading}
                                className="w-full h-14 mt-2 bg-indigo-600 hover:bg-indigo-700 text-white font-black text-base rounded-[1rem] shadow-[0_10px_30px_-10px_rgba(99,102,241,0.5)] transition-all hover:scale-[1.02] active:scale-95 disabled:opacity-50"
                            >
                                {isLoading ? (
